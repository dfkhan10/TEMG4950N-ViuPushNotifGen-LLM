      ...
      <div className="flex flex-grow bg-[#F5F5F5]">
        ...
        <div className="flex-grow flex flex-col items-start w-3/5 pt-8 pl-16">
          <div className="pl-8">
            {/* Back Button */}
            <button
              className="bg-white text-pink-500 border-2 border-pink-500 text-lg font-bold py-2 px-4 rounded-lg mb-4 hover:bg-pink-100 transition duration-300"
              onClick={() => navigate("/")}
            >
        ...
        <div className="flex flex-col justify-center items-center w-2/5">
          ...
          <div
            className="w-4/5 h-full bg-white flex flex-col rounded-lg shadow-md mt-4 overflow-y-auto"
